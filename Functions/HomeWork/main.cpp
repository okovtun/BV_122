...
void main()
{
	...
	if (rangeRand >= 20)
	{
		...
		else { RETURN; }	//Ïðè îòñóòñòâèè {} âî âðåìÿ âûçîâà define è ôóíêöèé âîçíèêàþò îøèáêè ÷åðåç ðàç. / If there is no {} during the call of define and functions, errors occur every other time.
	}
	...
	case 8: cout << "Sorted array using the Shell method: " << SortByShell(arr, R, C) << " iterations\n"; Aout(arr, R, C); break;
